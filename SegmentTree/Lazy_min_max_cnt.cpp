// Range Add → Add a value to all elements in [l,r]
//Range Query → Count negative elements in [l,r]
//Supports Min/Max tracking → Uses mn and mx to optimize updates
//Time: O(log n) per operation amortized (for this optimization)
